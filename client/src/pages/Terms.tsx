      ...
      <section className="py-20 bg-gray-50">
        <div className="container max-w-3xl">
          <div className="bg-white rounded-lg p-8 md:p-12 space-y-8 shadow-md border border-gray-100">
            {[
              { title: "Acceptance of Terms", content: "By accessing and using the Daksh Elevator Solutions website and services, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services." },
              { title: "Services", content: "Daksh Elevator Solutions provides elevator manufacturing, installation, maintenance, modernization, and repair services. All services are subject to separate agreements and quotations provided to the client." },
              ...
              { title: "Liability", content: "Daksh Elevator Solutions' liability is limited to the value of the contract. We are not liable for indirect, incidental, or consequential damages arising from the use of our products or services." },
              { title: "Intellectual Property", content: "All designs, technical drawings, specifications, and intellectual property related to our elevator systems remain the property of Daksh Elevator Solutions." },
              { title: "Contact", content: "For any questions regarding these Terms of Service, please contact us at info@daksh.com or call +91 98765 43210." },
            ].map((section) => (
